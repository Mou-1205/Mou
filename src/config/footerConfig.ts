...
export const footerConfig: FooterConfig = {
	...
	customHtml: '<span class="inline-flex items-center gap-2"><a class="transition link text-[var(--primary)] font-medium" target="_blank" href="https://beian.miit.gov.cn/#/Integrated/index" rel="noopener noreferrer">粤ICP备2026081944号</a> | <a class="transition link text-[var(--primary)] font-medium inline-flex items-center gap-1" href="https://beian.mps.gov.cn/#/query/webSearch?code=44011402001354" rel="noreferrer" target="_blank"><img src="/assets/beian-icon.png" alt="公安备案" width="14" height="14">粤公网安备44011402001354号</a></span>', // HTML格式的自定义页脚信息，例如备案号等，默认留空
